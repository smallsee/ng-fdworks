  ...
  var ScrollXiaohai = (function(){
    ...
    ScrollXiaohai.prototype = {
      ...
      _pageIcon : function(){
        ...
        me.iconUl.css({
          position : "absolute",
          width : me.horizontal ? me.settings.width : me.settings.icon.height - paddingTop,
          height :me.horizontal ? me.settings.icon.height : me.settings.height - paddingLeft,
          backgroundColor : me.settings.icon.ulColor,
          top:me.horizontal ? me.settings.height - me.settings.icon.height  : me.settings.icon.top,
      ...
      _initLayout : function(){
        ...
        this.ul.css({
          ...
          position:'relative',
          left: me.horizontal ? -this.settings.width * this.settings.index : 0,
          top : me.horizontal ? 0  : -this.settings.height * this.settings.index,
        }).addClass(ulClass);
        this.li.css({
          width:this.settings.width,
          height:this.settings.height,
